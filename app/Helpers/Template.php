...
Class Template {
	  ...
	  <tr>
		  <td data-bgcolor="bg-module" bgcolor="#eaeced">
			  <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
				  <tr>
					  <td class="img-flex"><img src="https://www.rocketspark.com/application/files/9615/1805/4233/cart-new.png" style="vertical-align:top;" width="600" height="306" alt="" /></td>
				  </tr>
				  <tr>
						  ...
						  <table width="100%" cellpadding="0" cellspacing="0">
							  ...
							  <tr>
								  <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:bold 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
									  Terima kasih anda telah bergabung dengan aplikasi kami, mohon menunggu konfirmasi dari kami selama 2x24 jam untuk proses validasi data anda.
								  </td>
							  </tr>
							  <tr>
								  <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:bold 20px/32px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
									  Lendtick
								  </td>
							  </tr>
						  </table>
  ...
  public static function email($n=false){
	return self::_get('email',$n);
  }

  private static function _get($t=false,$n=false){
	$ret = $n;
	if(strtolower($t)=="lang")
		$ret = isset(self::$lang[$n])?self::$lang[$n]:$n;
	if(strtolower($t)=="email")
		$ret = isset(self::$email[$n])?self::$email[$n]:$n;	
    return $ret;
  }
}
