    ...
    public function store(Request $request)
    {
      ...
      try {
       ...
       $check = array(
        ...
        'REQUESTDATETIME'   => '20190402065223', //$request_date, //yyyyMMddHHmmss
        'WORDS'             => sha1($channel_code . $request->sessionid . '20190402065223' . env('SHARED_KEY_BILLER') . $request->billerid . $request->accountnumber),  // Hashed key combination encryption using SHA1 method. The hashed key generated from combining these parameters in order.
